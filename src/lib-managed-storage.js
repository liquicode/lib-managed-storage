...
const LIB_MONGODB_STORAGE = require( './StorageProviders/MongodbStorage.js' );
const LIB_JSONDBFS_STORAGE = require( './StorageProviders/JsondbfsStorage.js' );
...
exports.NewManagedStorage =
	...
	{
		let managed_storage = {};
		managed_storage.StorageConfiguration = StorageConfiguration;
		...
		managed_storage.NewManagedObject =
			function _NewManagedObject( Owner, Prototype ) 
			{
				...
				let storage_configuration = managed_storage.StorageConfiguration;
		...
		managed_storage.ListAll =
			...
			{
				let interface_function = managed_storage.StorageConfiguration.interface.ListAll;
				let api_response =
				{
					ok: true,
		...
		managed_storage.ListMine =
			...
			{
				let interface_function = managed_storage.StorageConfiguration.interface.ListMine;
				let api_response =
				{
					ok: true,
					origin: `ManagedStorage.${interface_function.name}`,
		...
		managed_storage.FindOne =
			...
			{
				let interface_function = managed_storage.StorageConfiguration.interface.FindOne;
				let api_response =
				{
					ok: true,
					origin: `ManagedStorage.${interface_function.name}`,
		...
		managed_storage.FindMany =
			...
			{
				let interface_function = managed_storage.StorageConfiguration.interface.FindMany;
				let api_response =
				{
					ok: true,
					origin: `ManagedStorage.${interface_function.name}`,
